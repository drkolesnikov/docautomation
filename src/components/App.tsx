  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-[#070811] font-sans">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        {/* Header */}
        <header className="sticky top-0 z-40 flex items-center justify-between border-b border-white/[0.07] bg-[#070811]/70 backdrop-blur-2xl px-4 py-3 md:px-6 md:py-4">
          ...
          <button
            ...
            disabled={isStreaming}
            className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.06] px-3 py-2 text-sm font-medium text-white/70 hover:bg-white/[0.1] hover:border-white/20 hover:text-white disabled:opacity-30 transition-all duration-150 md:px-4"
          >
            <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {/* Main content */}
        <main className="flex flex-1 flex-col gap-3 p-3 md:flex-row md:gap-4 md:p-6">
          <div className="min-w-0 rounded-3xl border border-white/[0.08] bg-slate-900/50 p-4 shadow-2xl shadow-black/40 backdrop-blur-2xl ring-1 ring-inset ring-white/[0.04] md:flex-1 md:p-6">
